...
class _MainCarouselState extends State<MainCarousel> {
  ...
  final List<String> images = [
    "asset/images/ev1.jpg",
    "asset/images/ev2.jpg",
    "asset/images/ice2.jpg",
    "asset/images/ice3.jpg",
    "asset/images/ev2.jpg",
    "asset/images/ice4.jpg",
    "asset/images/ice5.jpg"
  ];
  final List<String> places = [
    'Himachal','Nepal','Manali','Leh','Solange','Kumbu','Namchibazzar'
  ];
  int _current = 0;
    ...
    return Stack(
      children: [
        ...
        AspectRatio(
          ...
          child: Center(
            child: Text(
              places[_current],style: TextStyle(
              letterSpacing: 8,
